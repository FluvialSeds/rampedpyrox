# *TODO: Add baseline subtraction option!!
...
def _rpo_extract_tg(file, nt, err, bl_subtract = True):
	'''
	...
	bl_subtract : Boolean
		...
		such that ppmCO2 returns to 0 at the end of the run. Treats baseline
	...
	zero could lead to slightly negative `g`). This method ensured that all
	values remain within this range.
